                ...
                if let onVisibilityChange {
                    Menu {
                        ...
                        if video.has_video {
                            ...
                            // The light 3D skeleton: free, on a CPU, seconds.
                            Button(refined == nil || refined == "failed" ? "3D Skeleton (free)" : "3D Skeleton · \(refined!)",
                                   systemImage: "figure.walk") { Task { await refine("refined") } }
